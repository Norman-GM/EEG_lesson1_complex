...
def make_parser():
    ...
    parser.add_argument('--model', type=str, help='model name', default='EEGConformer')
    parser.add_argument('--optimizer', type=str, help='optimizer name', default='Adam')
    parser.add_argument('--batch_size', type=int, help='batch size', default=64)
    parser.add_argument('--epochs', type=int, help='number of epochs', default=10)
    parser.add_argument('--learning_rate', type=float, help='learning rate', default=0.001)
    parser.add_argument('--val_interval', type=int, help='validation interval', default=5)
    ...
    parser.add_argument('--is_choose_best_hyper', type=bool, help='choose best hyperparameters', default=True)
    return parser
